...
export default function DestinationDetailPage() {
    ...
    return (
      <div className="pt-24 pb-20 min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/domestic" className="text-blue-600 hover:underline">
  ...
  return (
    <div className="pt-24 pb-20">
      ...
      {destination.price && (
        <section className="py-12 bg-gradient-to-r from-green-500 to-teal-600">
          <div className="container mx-auto px-4">
            <motion.div
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-3 bg-white text-green-600 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all"
              >
                Book Your Trip
              </motion.button>
            </motion.div>
